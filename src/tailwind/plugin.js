        ...
        typography: (theme) => ({
          DEFAULT: {
            css: {
              ...
              h4: { fontWeight: 600 },
              h5: { fontWeight: 600 },
              'h1 strong': { fontWeight: 600 },
              'h2 strong': { fontWeight: 600 },
              'h3 strong': { fontWeight: 600 },
              'h4 strong': { fontWeight: 600 },
              'h5 strong': { fontWeight: 600 },
            },
          },
          sm: {
            css: {
              ...
              h1: { fontSize: em(20, 14) },
              h2: { fontSize: em(18, 14) },
              h3: { fontSize: em(16, 14) },
              h4: { fontSize: em(14, 14) },
              h5: { fontSize: em(13, 14) },
              p: { marginTop: '0.5rem', marginBottom: '1rem' },
